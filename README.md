...
> **Если ты разработчик (или AI-агент) и продолжаешь этот проект — начни с трёх первых файлов в этом порядке.**

| Документ | Описание |
|----------|----------|
| 🟢 **[HANDOFF.md](docs/HANDOFF.md)** | **Старт здесь.** Что сделано, какие были ловушки, чего не делать. |
| 🟢 **[ROADMAP.md](docs/ROADMAP.md)** | **Пошаговый план.** Phase 1 → 2 → 3. Чек-листы. |
| 🟢 **[DESIGN.md](docs/DESIGN.md)** | **Дизайн-спека UI.** Цвета, шрифты, отступы — обязательно перед UI-кодом. |
...
**Важно:** KASTOL — образовательный проект, целью которого является **визуально красивый минималистичный оверлей-меню** для CS2.

- ✅ В проекте реализован **только визуальный слой** (UI, watermark, FPS-счётчик).
- ❌ В проекте **нет и не будет** функций, влияющих на геймплей: aim-assist, wallhack, triggerbot и т.п. Это политика проекта, а не пожелание.
- 🚫 Использование любых инжектируемых модификаций в Counter-Strike 2 может быть расценено Valve как нарушение правил и привести к VAC-блокировке аккаунта. Используйте только на свой страх и риск.
